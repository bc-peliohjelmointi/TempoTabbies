...
public class PlayerScoreManager : MonoBehaviour
{
    ...
    public int playerIndex = 0; // Set this in inspector for each player
    ...
    private void Start()
    {
        // Register with multiplayer coordinator if it exists
        if (MultiplayerScoreCoordinator.Instance != null)
        {
            MultiplayerScoreCoordinator.Instance.RegisterScoreManager(playerIndex, this);
        }
    }
